...
class TrenchingScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new TrenchingScreenState();
  }
}

class TrenchingScreenState extends State<TrenchingScreen> {
  @override
                  ...
                  Form(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Text("How has the trench been left"),
                            SizedBox(
                              height: 14,
                            ),
                            InputDecorator(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<String>(
                                  // hint: Text("Select Device"),
                                  value: trenchSelectedValue,
                                  icon: Icon(Icons.keyboard_arrow_down),
                                  iconEnabledColor: Colors.yellow[600],
                                  isDense: true,
                                  onChanged: (newValue) {
                                    setState(() {
                                      trenchSelectedValue = newValue;
                                    });
                                    print(trenchSelectedValue);
                                  },
                                  items: trenchTypes.map((String value) {
                                    return DropdownMenuItem<String>(
                                      value: value,
                                      child: Text(value),
                                    );
